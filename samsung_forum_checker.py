...
series_info = {
    ...
    "TriFold(1)" : {"series": "Z-Trifold", "series_code": "ztrifold"},
    "TriFold(2)" : {"series": "Z-TriFold", "series_code": "ztrifold"},
    "TriFold(3)" : {"series": "Trifold", "series_code": "ztrifold"},
    "TriFold(4)" : {"series": "TriFold", "series_code": "ztrifold"},
    "TriFold(5)" : {"series": "Trifold", "series_code": "trifold"},
    "TriFold(6)" : {"series": "TriFold", "series_code": "trifold"},
    "TriFold(7)" : {"series": "Z-Trifold", "series_code": "trifold"},
    "TriFold(8)" : {"series": "Z-TriFold", "series_code": "trifold"},
